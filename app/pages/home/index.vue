...
const handleSentarClienteConfirm = () => {
  ...
  const mesa = mesasData.value.find((mesa: any) => mesa.id === formDataSentarCliente.mesaId);
...
<template>
  <main class="relative flex p-4">
    ...
    <div class="mx-auto flex h-full gap-4">
      ...
      <div class="mx-auto w-[400px] border border-surface-300 p-4 dark:border-surface-700">
