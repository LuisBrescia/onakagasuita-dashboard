...
const handleSelectUnidade = (unidade: Unidade): void => {
  ...
  emits('unidade-selected', unidade);
};
...
<template>
  <div class="c-sidebar__body__select-unidade" @click="handleSelectUnidadePopover">
    <div class="c-sidebar__body__select-unidade__leading">
      <!-- <div class="branding-square custom-background w-8" /> -->
      <AppAvatar :letra="unidadeStore.unidade?.nome_fantasia[0]" shape="square" size="large" />
      <div class="c-sidebar__body__select-unidade__leading__info">
        ...
        <h5 class="c-sidebar__body__select-unidade__leading__info__name">
          {{ unidadeStore.unidade ? unidadeStore.unidade.nome_fantasia : 'Selecione uma unidade' }}
        </h5>
      </div>
    </div>
  ...
  >
    <div class="ms-auto flex items-center justify-between gap-2 p-2">
      ...
      <div class="flex">
        ...
        <span
          class="c-select-unidade-popper__pagination-arrow"
          :class="{
            disabled: unidadePagination.current_page === unidadePagination.last_page,
          }"
          @click="handlePaginate(1)"
        >
    ...
    <div
      class="flex cursor-pointer items-center justify-between p-2 text-surface-900 hover:bg-primary-subtle-light dark:text-surface-0 dark:hover:bg-primary-subtle"
