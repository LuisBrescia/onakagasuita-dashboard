...
<template>
  ...
  >
    ...
    <div class="p-4">
      ...
      <div class="mb-2">
        <h4 class="text-xs text-surface-600 dark:text-surface-400">Horário de funcionamento</h4>
        <p class="text-sm">
      ...
      <div class="mb-2">
        <h4 class="text-xs text-surface-600 dark:text-surface-400">Dias de funcionamento</h4>
